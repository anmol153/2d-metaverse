...
const apiKey = process.env.LIVEKIT_API_KEY || "123432";
const apiSecret = process.env.LIVEKIT_API_SECRET || "mnbvcxz0987654321mnbvcxz09876543";
const wsUrl = process.env.LIVEKIT_URL  || 'http://localhost:7880';
